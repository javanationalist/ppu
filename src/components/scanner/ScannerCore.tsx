...
export default function ScannerCore({
  containerId = 'qr-reader-admin-pro-container',
  title = 'Super QR Scanner (PRO)',
  subtitle = 'Alur instan tanpa klik tombol. Pemilih otomatis terverifikasi dan aktif begitu QR Code terbaca sistem.'
}: ScannerCoreProps) {
          ...
          <Card className="border border-slate-200 shadow-sm p-5 space-y-4">
            ...
            >
              ...
              <button
                ...
                className="bg-indigo-600 hover:bg-indigo-700 disabled:opacity-50 text-white text-xs font-bold px-4 py-2 rounded-md transition-colors shadow-sm cursor-pointer"
              >
                Cari & Konfirmasi
              </button>
            </form>
              ...
              <div className="flex gap-2">
                {cameras.length > 1 && (
                  <button
                    ...
                    className="flex-1 flex items-center justify-center gap-1.5 bg-slate-600 hover:bg-slate-700 text-white font-bold text-xs py-2 px-3 rounded-md transition-colors cursor-pointer"
                  >
                ...
                <button
                  type="button"
                  onClick={stopScanner}
                  className="flex-1 bg-red-600 hover:bg-red-700 text-white font-bold text-xs py-2 px-3 rounded-md transition-colors cursor-pointer"
                >
                  Batal Scan
                </button>
              </div>
            ...
            {!isScanning && (
              <button
                type="button"
                onClick={startCamera}
                className="w-full flex items-center justify-center gap-2 bg-slate-100 hover:bg-indigo-50 hover:text-indigo-600 text-slate-700 font-bold text-sm py-2 px-4 rounded-md transition-colors border border-slate-300 hover:border-indigo-200 cursor-pointer"
              >
            ...
            <div className="p-6 flex-1 flex flex-col justify-center relative">
              ...
              {foundVoter ? (
                <div className="space-y-6">
                  ...
                  <div className="pt-6 border-t border-slate-200">
                    <button
                      ...
                      className="w-full flex justify-center items-center gap-2 bg-indigo-50 hover:bg-indigo-100 text-indigo-700 font-bold text-xs py-3 px-4 rounded-xl transition-all border border-indigo-200 cursor-pointer"
                    >
                ...
                <div className="text-center py-10 opacity-75">
                  ...
                  <h4 className="text-slate-700 font-black text-sm">Pemindaian Instan</h4>
