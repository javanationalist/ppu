...
export default function ConfirmAccount() {
  ...
  const startScanner = async (cameraId: string) => {
    try {
      ...
      const scanner = new Html5Qrcode('qr-reader-confirm-account-container');
      ...
      await scanner.start(
        ...
        (decodedText) => {
          ...
          console.log('[Confirm Account Scanner] Data detected:', cleanCardId);
  ...
  // Automated Search & Confirm (No Unconfirm)
    ...
    try {
      ...
      if (profile && !profile.is_deleted) {
        ...
        if (profile.account_status !== 'dikonfirmasi') {
          console.log('[Confirm Account] Automatically confirming voter:', profile.full_name);
          ...
          <div>
            <div className="flex items-center gap-2">
              <span className="px-2.5 py-0.5 bg-indigo-500/20 text-indigo-300 border border-indigo-500/30 text-[10px] font-black uppercase tracking-widest rounded-full flex items-center gap-1">
                ...
                <span>Confirm Account Mode</span>
              </span>
            </div>
            <h1 className="text-2xl font-black text-white mt-1">Konfirmasi Akun Pemilih</h1>
            <p className="text-slate-300 text-sm mt-1">
              Alur instan pemindaian QR Code untuk mengonfirmasi status pendaftaran akun pemilih.
            </p>
          </div>
        ...
        <div className="lg:col-span-5 space-y-6">
          <Card className="border border-slate-200 shadow-sm p-5 space-y-4">
            ...
            <div className={`space-y-3 ${isScanning ? 'block' : 'hidden'}`}>
              <div 
                id="qr-reader-confirm-account-container" 
            ...
            <div className="p-6 flex-1 flex flex-col justify-center relative">
              ...
              {foundVoter ? (
                ...
                <div className="text-center py-10 opacity-75">
                  ...
                  <h4 className="text-slate-700 font-black text-sm">Pemindaian Instan Konfirmasi Akun</h4>
